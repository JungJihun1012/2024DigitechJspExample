			...
			<form name="form" action="action.jsp" method="post" onsubmit="return validate();">
				...
				<table style="width: 400px;">
					<tr>
						<th>회원번호(자동생성)</th>
						<td>
							<input name="user" type="text" value="<%=rs.getString("custno") %>">
						</td>
					</tr>
					<tr>
						<th>회원성명</th>
						<td>
							<input type="text" name="custname" value="<%=rs.getString("custname")%>">
						</td>
					</tr>
					<tr>
						<th>회원전화</th>
					...
					<tr>
						<th>가입일자</th>
						<td>
							<input type="date" name="joindate" value="<%=rs.getDate("joindate") %>">
						</td>
					</tr>
					<tr>
						<th>고객등급[A: VIP, B:일반, C:직원]</th>
						<td>
							<input name="grade" type="text" value="<%=rs.getString("grade")%>">
						</td>
					</tr>
					<tr>
						<th>도시코드</th>
						<td>
							<input name="city" type="text" value="<%=rs.getString("city") %>">
						</td>
					</tr>
					<tr>
